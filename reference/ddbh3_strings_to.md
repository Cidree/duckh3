...
- h3string:
  ...
  The name of a column in `x` containing the H3 strings
...
- `ddbh3_strings_to_spatial()` converts H3 indexes to spatial hexagon
  polygons

- `ddbh3_strings_to_lon()` extracts the longitude of the H3 cell
  centroid
