...
#> #
#> # Source:   table<temp_view_8cd245d6_e8b6_405b_8c59_7514c0744f02> [?? x 8]
#> # Database: DuckDB 1.5.2 [unknown@Linux 6.17.0-1010-azure:R 4.5.3/:memory:]
...
#> # Use ddbs_collect() or st_as_sf() to materialize to sf
#> #
#> # Source:   table<temp_view_4eb8d364_4cad_4f86_ab6a_6e89b3327b01> [?? x 8]
#> # Database: DuckDB 1.5.2 [unknown@Linux 6.17.0-1010-azure:R 4.5.3/:memory:]
#>        X    id    lat   lon category h3string        h3vertex  geometry         
#>    <int> <int>  <dbl> <dbl> <chr>    <chr>           <list>    <wk_wkb>         
#>  1     6     6 -56.2   21.5 B        88e69d233dfffff <chr [6]> <MULTIPOINT ((21…
#>  2    11    11 -40.8  -90.6 B        88ce6ab549fffff <chr [6]> <MULTIPOINT ((-9…
#>  3    12    12 -40.9   78.9 C        88cc1965b7fffff <chr [6]> <MULTIPOINT ((78…
#>  4    13    13 -15.2  -74.0 A        888e6b896bfffff <chr [6]> <MULTIPOINT ((-7…
#>  5    19    19  25.8  -24.4 B        8834ea3829fffff <chr [6]> <MULTIPOINT ((-2…
#>  6    20    20  59.8  -79.8 B        880e0229b1fffff <chr [6]> <MULTIPOINT ((-7…
#>  7    21    21  41.0   64.8 A        88219d3247fffff <chr [6]> <MULTIPOINT ((64…
#>  8    30    30 -18.5   52.6 A        88a22bb331fffff <chr [6]> <MULTIPOINT ((52…
#>  9    46    46   9.94  31.2 A        886b5bcc8bfffff <chr [6]> <MULTIPOINT ((31…
#> 10    47    47 -39.1   52.2 C        88ca30ac1dfffff <chr [6]> <MULTIPOINT ((52…
#> # ℹ more rows
```
